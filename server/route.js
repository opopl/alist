...
//@@ Images
    ...
    router.post('/img/info'         , self.c_Img.jsonImgInfo())
...
//@@ Sec
    ...
    router.get('/prj/sec/tree'  , self.c_Prj.jsonSecTree())
    router.get('/prj/sec/tree/html'  , self.c_Prj.htmlSecTree())
...
//@@ Sec/Table
    router.get('/prj/sec/table/:table/html'  , self.c_Prj.htmlSecTable())
